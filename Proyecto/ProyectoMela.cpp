...
string eliminarEspaciosEnBlanco(const string& texto);
/*---------------------------------------------------------------------------------------------------*/
...
int main() {
	...
	cout << "> Nota: Recuerda dar enter para confirmar el ingreso" << endl;
    for (int k = 0; k < Num_Poli; k++) { // Iterar las veces que se desea para leer polinomios
		...
		polinomio = eliminarEspaciosEnBlanco(polinomio);
